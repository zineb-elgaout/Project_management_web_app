...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a href="#" class="nav-link active"><i class="bi bi-newspaper me-2"></i> Actualités</a>
            ...
            <a href="message.php" class="nav-link"><i class="bi bi-envelope-fill me-2"></i>Messages</a>
