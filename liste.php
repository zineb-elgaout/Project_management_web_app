...
try {
    ...
    $query = "SELECT 
      ...
      WHERE p.id_enseignant = :id_enseignant"; // Filtre principal par encadrant
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a href="#" class="nav-link active"><i class="fas fa-list-ul me-2"></i>Liste des projets</a>
        ...
        <div class="container py-5 flex-grow-1">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p >Filtrez et consultez les projets par filière, statut, année et mois</p>
                </div>
            </div>
            ...
            <div class="search-box card mb-4">
                <form method="GET" action="">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <label for="type_projet" class="form-label" style="color: var(--text-primary);">Type de projet</label>
                            <select class="form-select" name="type_projet" id="type_projet">
                                <option value="">Tous les types</option>
                                <?php foreach ($typesProjet as $type): ?>
                                    <option value="<?= htmlspecialchars($type) ?>" <?= $selectedTypeProjet === $type ? 'selected' : '' ?>>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <label for="statut" class="form-label" style="color: var(--text-primary);">Statut</label>
                            <select class="form-select" name="statut" id="statut">
                                <option value="">Tous les statuts</option>
                                <?php foreach ($statuts as $statut): ?>
                                    <option value="<?= htmlspecialchars($statut) ?>" <?= $selectedStatut === $statut ? 'selected' : '' ?>>
                                        <?= str_replace('_', ' ', htmlspecialchars($statut)) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <label for="annee" class="form-label"style="color: var(--text-primary);">Année</label>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <label for="mois" class="form-label"style="color: var(--text-primary);">Mois</label>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 d-flex align-items-end mb-3">
                            <button class="btn btn-primary w-100 " type="submit">
                                <i class="fas fa-search align-items-center align-content-centerc me-3"></i>Chercher
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <?php if (isset($_SESSION['success_message'])): ?>
            ...
            <?php if (empty($projects)): ?>
                <div class="alert alert-info">
                    ...
                    if (!empty($selectedTypeProjet)) $filters[] = "type: " . htmlspecialchars($selectedTypeProjet);
                    if (!empty($selectedStatut)) $filters[] = "statut: " . str_replace('_', ' ', htmlspecialchars($selectedStatut));
            ...
            <?php elseif (!empty($projects)): ?>
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4>
                        <?= !empty($selectedFiliere) ? "Filière : " . htmlspecialchars($selectedFiliere) : "Toutes les filières" ?>
                        <?php if (!empty($selectedTypeProjet)) echo " - Type: " . htmlspecialchars($selectedTypeProjet); ?>
                        <?php if (!empty($selectedStatut)) echo " - Statut: " . str_replace('_', ' ', htmlspecialchars($selectedStatut)); ?>
